...
import PostUI from "../../components/commons/post/PostUI";
import { GET_POST_BY_POST_ID } from "../../components/utils/apollo/graphql/queries";
import { SubmitHandler, useForm } from "react-hook-form";
import { ADD_COMMENT } from "../../components/utils/apollo/graphql/mutations";
      ...
      <div className="-my-5 rounded-b-md border border-t-0 border-gray-300 bg-white py-5 px-10 ">
        ...
        {post?.comments.map((comment) => (
          ...
          >
            ...
            <div className="z-50">
              <AvatarUI seed={comment.username} />
            </div>
